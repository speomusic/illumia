...
#include <merc/ivstgraphicshost.h>
#include <windows.h>
#include <wrl.h>
...
struct Texcube : merc::VideoEffect
{
    ...
    static const char* getName() { return "texcube"; }
    Texcube()
    {
        addVideoOutput(u"Out", DXGI_FORMAT_R8G8B8A8_UNORM, 4);
    }

    Steinberg::tresult PLUGIN_API initialize(Steinberg::FUnknown* context) override
    {
        if (auto parentStatus{ VideoEffect::initialize(context) }; parentStatus != Steinberg::kResultOk) return parentStatus;
        ...
        THROW_IF_FAILED(graphicsDevice->CreateRootSignature(0, serializedRootSignature->GetBufferPointer(), serializedRootSignature->GetBufferSize(), IID_PPV_ARGS(&rootSignature)));
        ...
        UINT compileFlags = 0;
#endif
        const std::wstring shadersPath{ (merc::getModuleResourceDir() / "texcube.hlsl").wstring() };
        ...
        D3D12_GRAPHICS_PIPELINE_STATE_DESC psoDesc
        {
            ...
            .NumRenderTargets = 1,
            .RTVFormats = { videoOutputs[0]->format },
            .SampleDesc = { .Count = videoOutputs[0]->msaaCount },
        };
        THROW_IF_FAILED(graphicsDevice->CreateGraphicsPipelineState(&psoDesc, IID_PPV_ARGS(&pipelineState)));
        ...
        THROW_IF_FAILED(graphicsDevice->CreateCommittedResource(
...
template struct merc::Module<Texcube>;
