...
private:
  ...
  void
  addClassesOrRecurse(const std::filesystem::path &dir,
  ...
  static bool isInDirs(const std::filesystem::path &path,
                       const std::set<std::filesystem::path> &dirs);
